<template>
  <div class="dashboardTabMain">
    <div class="controlTableMain">
      ...
      <History-table :big-size="!store.isMobile" :rows="tableData" :loading="loading"/>
    </div>
    <sensor-chart :big-size="!store.isMobile"  maxWidth :chart-data="chartData" label="Sensor data"/>
    <div v-if="store.isMobile" class="mobilePadding" />
...
import HistoryControl from 'src/components/HistoryControl.vue'
...
import { rawToXY } from 'src/api/util'
